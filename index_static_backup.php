...
<head>
    ...
    <title>Votre Nom | Bilan de Compétences & Avenir Professionnel</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --------------------------------- */
        #accueil { min-height: 100vh; display: flex; align-items: center; justify-content: center; text-align: center; position: relative; background-image: url('https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=2070&auto=format&fit=crop'); background-attachment: fixed; background-position: center; background-repeat: no-repeat; background-size: cover; }
...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <a href="#accueil" class="logo">Votre Nom</a>
            <nav class="main-nav">
    ...
    <main>
        ...
        <section id="accueil">
            <div class="hero-content">
                <h1 class="animated-title">Révélez votre potentiel.<br>Redessinez votre avenir.</h1>
                <p class="fade-in" style="transition-delay: 0.5s;">Accompagnement personnalisé pour trouver le chemin professionnel qui vous ressemble vraiment.</p>
                <a href="#contact" class="cta-button fade-in" style="transition-delay: 0.7s;">Prendre un rendez-vous gratuit</a>
            </div>
        </section>
        ...
        <section id="a-propos">
            <div class="container">
                <div class="about-image fade-in">
                    <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=1888&auto=format&fit=crop" alt="Portrait professionnel de la coach">
                </div>
                <div class="about-text fade-in" style="transition-delay: 0.2s;">
                    <h2>À propos de moi</h2>
                    <h3>Plus qu'un métier, une vocation : la vôtre.</h3>
                    <p>Après 15 ans dans les ressources humaines, j'ai choisi de me consacrer à ce qui m'anime le plus : l'humain. Ma mission est de vous fournir les outils et la clarté nécessaires pour que vous puissiez, à votre tour, vous épanouir dans une carrière qui a du sens.</p>
                     <p>Mon approche est humaine, bienveillante et structurée. Elle allie les outils concrets du bilan de compétences à une écoute active de vos aspirations profondes.</p>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            <div class="container">
                <div class="fade-in">
                    <h2>Faisons le premier pas ensemble</h2>
                    <p class="section-subtitle fade-in">
                        Prêt(e) à discuter de votre avenir ? Utilisez le formulaire ci-dessous pour toute question ou pour planifier notre premier appel découverte, gratuit et sans engagement.
                    </p>
                </div>

                <form action="#" method="POST" class="contact-form fade-in">
    ...
    <footer class="main-footer">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column">
                    <h4>Coordonnées</h4>
                    <p>123 Rue de l'Avenir<br>75000 Paris, France</p>
                    <a href="mailto:contact@votrenom.fr">contact@votrenom.fr</a>
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 Votre Nom - Tous droits réservés. | <a href="#">Mentions Légales</a></p>
            </div>
        </div>
    </footer>
